...
function openRegisterModal() {
    "use strict";
    $.ajax({
        url: 'ajax/registration.php', success: function (result) {
            $('.modal-dialog').html(result);
        }
    });
    $('#loginModal').modal('show');
...
function showRegisterFields(user) {
    "use strict";
    if (user == 1) {
        $.ajax({
            url: 'ajax/regseeker.php', success: function (result) {
        ...
        $.ajax({
            url: 'ajax/regprovider.php', success: function (result) {
                $('.modal-body').html(result);
            }
        });
    }
